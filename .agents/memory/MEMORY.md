...
- [RBAC role sync](rbac-role-sync.md) — role changes must sync usersTable + orgMembersTable; member routes admin-guarded; reviewer allowlist is exact POST doc/report paths only.
